...
--------
  ...
  * The server requires sumcoind, leveldb and plyvel

  * The server code is open source. Anyone can run a server, removing
    single points of failure concerns.

  * The server knows which set of Sumcoin addresses belong to the same
...
------------
  ...
  2. To start and stop the server, use the 'electrum-sum-server' script
